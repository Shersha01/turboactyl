...
console.log(chalk.green("[Turboactyl] Files loading..."));

console.log(chalk.green("[Turboactyl] Files loaded..."));

// Load settings.

const settings = require("./settings.json");
console.log(chalk.green("[Turboactyl] Settings loading..."));
...
console.log(chalk.green("[Turboactyl] Settings loaded..."));
...
console.log(chalk.green("[Turboactyl] Database loading..."))

module.exports.db = db;

console.log(chalk.green("[Turboactyl] Database loaded..."))

// Load websites.

const express = require("express");
console.log(chalk.green("[Turboactyl] api's loading..."))
const app = express();
console.log(chalk.green("[Turboactyl] api's loaded..."))

// Load express addons.

const expressWs = require('express-ws')(app);
console.log(chalk.green("[Turboactyl] Express addons loading..."))
const ejs = require("ejs");
const session = require("express-session");
const indexjs = require("./index.js");
console.log(chalk.green("[Turboactyl] Express addons loaded..."))


// Sets up saving session data.

const sqlite = require("better-sqlite3");
console.log(chalk.green("[Turboactyl] Season data loading..."))
const SqliteStore = require("better-sqlite3-session-store")(session);
const session_db = new sqlite("sessions.db");
console.log(chalk.green("[Turboactyl] Season data loaded..."))

// Load the website.

module.exports.app = app;
console.log(chalk.green("[Turboactyl] Website loading..."))
...
console.log(chalk.blue("[Turboactyl] ©️ Turbonodes:  \n Links:   \n [Github] https://github.com/turboactyl/turboactyl \n [Discord] https://discord.gg/kcSdY67tj4"));
console.log(chalk.yellow("=================================================="))
console.log(chalk.gray("[Contributors] \n [Demon Emperor NightmareGods#2086]"));
console.log(chalk.yellow("=================================================="))

const listener = app.listen(settings.website.port, function() {
  console.log(chalk.green("[Turboactyl] Loaded Website on the port " + listener.address().port +" "));
});
